 ...
 * @author kevin
 */
public class ArreglosController implements Initializable {

    @FXML
    private Label lbl1,lbl2,lbl3,lbl4,lbl5,lbl6,lbl7;
    
    @FXML
    private Label lblAst1,lblAst2,lblAst3,lblAst4,lblAst5,lblAst6,lblAst7;
    
    @FXML
    private RadioButton blusa_radioBtn,pollera_radioBtn,bolsicon_radioBtn,
            panio_radioBtn,joyeria_radioBtn;
    ...
    void dashBoardClicksPrincipal(MouseEvent event) throws IOException {
        if (event.getSource() == blusa_radioBtn) {
            ...
            lblAst1.setVisible(true); lblAst2.setVisible(true);lblAst3.setVisible(true);lblAst4.setVisible(true);lblAst5.setVisible(true);
            lblAst6.setVisible(true);lblAst7.setVisible(true);
            ...
            lblAst1.setVisible(true); lblAst2.setVisible(true);lblAst3.setVisible(true);lblAst4.setVisible(false);lblAst5.setVisible(false);
            lblAst6.setVisible(false);lblAst7.setVisible(false);
            ...
            lblAst1.setVisible(false); lblAst2.setVisible(false);lblAst3.setVisible(false);lblAst4.setVisible(false);lblAst5.setVisible(false);
            lblAst6.setVisible(false);lblAst7.setVisible(false);
            ...
            lblAst1.setVisible(true); lblAst2.setVisible(false);lblAst3.setVisible(false);lblAst4.setVisible(false);lblAst5.setVisible(false);
            lblAst6.setVisible(false);lblAst7.setVisible(false);
